...
import 'binance_renderer/n_chart_painter.dart';
import 'chart_style.dart';
import 'entity/candle_chart/info_window.dart';
import 'renderer/chart_painter.dart';
import 'utils/date_format_util.dart' hide S;
import 'utils/number_util.dart';

class CandleChartWidget extends StatefulWidget {
  final List<CandleChartEntity>? datas;
...
class _CandleChartWidgetState extends State<CandleChartWidget>
  ...
  StreamController<InfoWindow?>? mInfoWindowStream;
  double mWidth = 0;
  ...
  void initState() {
    super.initState();
    mInfoWindowStream = StreamController<InfoWindow?>();
    ...
    return StreamBuilder<InfoWindow?>(
        ...
        builder: (context, snapshot) {
          if (!isLongPress ||
              widget.isLine == true ||
              !snapshot.hasData ||
              snapshot.data?.candleChartEntity == null) return Container();
          CandleChartEntity entity = snapshot.data!.candleChartEntity;
          double upDown = entity.close - entity.open;
          double upDownPercent = upDown / entity.open * 100;
          infos = [
            getDate(entity.openTime),
